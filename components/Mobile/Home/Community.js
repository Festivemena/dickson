...
import Commun from '../../community/Commun'
...
import Comcarousel from '../../community/comCarousel'
...
function Community () {
  ...
  const[selected, setSelected]=useState()
    ...
    <div className='flex-[1] sticky border-b border-[#C4C4C4] justify-center'> <NavBar initialSelectedIcon={'World'} /></div>
      <div className='pt-3 pl-3 font-semibold text-[16px] mb-3'>Your Communities</div>
      <div className=' w-full border-b pb-[12px] border-[#C4C4C4] text-center'>
    <Comcarousel />
    </div>
    <div>
      <div className='text-[16px] pt-3 pl-3 mb-3 font-semibold'>Explore Other Communites</div>
      <div className='flex' onClick={() => router.push('/community/mena')}>
        <div className='h-[72px] w-[72px] ml-3 rounded-[8px] bg-[#D9D9D9]'></div>
        <div className='flex-1 justify-between ml-[16px]'>
        <div className='font-semibold text-[12px]'>Uniben Verse</div>
        <div className='text-[10px] mt-[5px]'>32 members</div>
        <div className='mt-4'>
        <Image src={jk} /> 
        <Image src={jl} /> 
        <Image src={jh} /> 
