...
import Noti from '../../login/noti'
import Stylex from '../../../styles/Home.module.css'
...
const style = 
{
    ...
    drawer: `text-black font-bold w-full  pt-2 pb-3 flex  justify-between`,
    nav: `flex-[1] sticky border-b bborder-[#C4C4C4] justify-center`,
}
...
function Mobile () {
    ...
    <div className={style.nav}> <NavBar initialSelectedIcon={'World'} /></div> 
    <div >
